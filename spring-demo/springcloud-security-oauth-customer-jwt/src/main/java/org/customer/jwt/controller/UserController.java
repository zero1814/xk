package org.customer.jwt.controller;
...
public class UserController {
	...
	public ResponseEntity<OAuth2AccessToken> login(@Valid UserLoginDto loginDto, BindingResult bindingResult)
			throws Exception {

		if (bindingResult.hasErrors())
			throw new Exception("登录信息错误，请确认后再试");

		ScUser user = userRepository.findByUserName(loginDto.getUserName());
		...
		// 获取 Token
		return restTemplate.exchange(oAuth2ProtectedResourceDetails.getAccessTokenUri(), HttpMethod.POST, httpEntity,
